export type NamedLilNounSeed = LilNounParts & { background: LilNounBgColors };

export type LilNounSeed = { [T in keyof NamedLilNounSeed]: number };
export type RLELilNounSeed = { [T in keyof NamedLilNounSeed]: number | string };

export type LilNounBgColors = "#d5d7e1" | "#e1d7d5";
export type LilNounParts = {
	bodies: BodiesPart;
