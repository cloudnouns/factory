export type NamedNounSeed = NounParts & { background: NounBgColors };

export type NounSeed = { [T in keyof NamedNounSeed]: number };
export type RLENounSeed = { [T in keyof NamedNounSeed]: number | string };

export type NounBgColors = "#d5d7e1" | "#e1d7d5";
export type NounParts = {
	bodies: BodiesPart;
